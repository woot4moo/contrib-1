 ...
 * 
 */
public class DeliveryParameter implements org.apache.thrift.TBase<DeliveryParameter, DeliveryParameter._Fields>, java.io.Serializable, Cloneable, Comparable<DeliveryParameter> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DeliveryParameter");
  ...
  static {
    schemes.put(StandardScheme.class, new DeliveryParameterStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DeliveryParameterTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DeliveryParameter.class, metaDataMap);
  }

  public DeliveryParameter() {
  }
   ...
   */
  public DeliveryParameter(DeliveryParameter other) {
  ...
  public DeliveryParameter deepCopy() {
    return new DeliveryParameter(this);
  }
   ...
   * *
   */
  public DeliveryParameter setInboxProtocol(String inboxProtocol) {
    this.inboxProtocol = inboxProtocol;
    return this;
  }
   ...
   * *
   */
  public DeliveryParameter setInboxAddress(String inboxAddress) {
    this.inboxAddress = inboxAddress;
    return this;
  }
   ...
   * *
   */
  public DeliveryParameter setDeliveryMessageBinding(String deliveryMessageBinding) {
    this.deliveryMessageBinding = deliveryMessageBinding;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DeliveryParameter)
      return this.equals((DeliveryParameter)that);
    return false;
  }

  public boolean equals(DeliveryParameter that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(DeliveryParameter other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DeliveryParameter(");
    boolean first = true;
  ...
  private static class DeliveryParameterStandardSchemeFactory implements SchemeFactory {
    public DeliveryParameterStandardScheme getScheme() {
      return new DeliveryParameterStandardScheme();
    }
  }

  private static class DeliveryParameterStandardScheme extends StandardScheme<DeliveryParameter> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DeliveryParameter struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DeliveryParameter struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class DeliveryParameterTupleSchemeFactory implements SchemeFactory {
    public DeliveryParameterTupleScheme getScheme() {
      return new DeliveryParameterTupleScheme();
    }
  }

  private static class DeliveryParameterTupleScheme extends TupleScheme<DeliveryParameter> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DeliveryParameter struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DeliveryParameter struct) throws org.apache.thrift.TException {
